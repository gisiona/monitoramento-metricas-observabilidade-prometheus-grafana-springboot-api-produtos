package com.gisiona.example.resilience4j.avaliacao.infra.database;

import com.gisiona.example.resilience4j.avaliacao.domain.Avaliacao;
import com.gisiona.example.resilience4j.avaliacao.domain.AvaliacaoRepository;
